  ...
  return (
    <div className="form-section fade-in">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="form-field">
          <label htmlFor="fonteRenda" className="form-label">
            Fonte de Renda
          </label>
          <select
            id="fonteRenda"
      ...
      <div className="mt-8 p-4 bg-green-50 border-l-4 border-green-400 text-green-700">
        ...
        <p className="text-sm">
          Certifique-se de que todos os dados estão corretos antes de prosseguir. Isso ajudará a
          agilizar o processo de análise do seu empréstimo.
        </p>
      </div>
    </div>
  );
