  ...
  return (
    <div class="flex mx-auto justify-center items-center">
      <div class="grid grid-cols-1 xl:grid-cols-3 gap-6 m-8">
        <div class="flex flex-col rounded-2xl w-full xl:w-96 bg-[#000000] text-[#ffffff] shadow-xl">
          ...
          <div class="flex flex-col p-8 h-full">
            ...
            <div class=" text-center text-lg pb-12">
            ...
            <div class="flex pt-10">
              <button class="w-full bg-[#23cf29] text-[#000000] font-bold text-base p-3 rounded-lg hover:bg-purple-800 active:scale-95 transition-transform transform">
        ...
        <div class="flex flex-col rounded-2xl w-full xl:w-96 bg-[#000000] text-[#ffffff] shadow-xl">
          ...
          <div class="flex flex-col p-8 h-full">
            <div class="text-3xl text-center font-bold pb-6">Premium</div>
            <div class=" text-center text-lg pb-12">
